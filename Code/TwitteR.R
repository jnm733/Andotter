...
#Ejemplo obtención tweets
CorrupcionTweets = searchTwitter("Albert Rivera condiciones", n=10, lang = "es", resultType = "recent", since='2016-04-10')
CorrupcionTweets

str(CorrupcionTweets[1])


bigdata <- searchTwitter("@ESLspain", n=10)
